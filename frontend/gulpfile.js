...
gulp.task("template:export", templatePipeline({
  name: "export.html",
  input: paths.resources + "templates/export.mustache",
  output: paths.output
}));

gulp.task("templates", gulp.series("svg:sprite:icons", "svg:sprite:cursors", "template:main", "template:export"));
